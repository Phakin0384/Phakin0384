...
- 📱 **Mobile App Development** - Creating user-friendly mobile experiences
- 🎨 **UI/UX Design** - Designing intuitive interfaces with Figma
- ⚙️ **Backend Systems** - Developing robust server-side solutions
- 🐳 **DevOps** - Containerizing and deploying applications with Docker
...
I'm always open to collaboration, learning, and discussing interesting projects.
